...
export class CityService {
  ...
  private getCites() {
    const api = 'https://www.easy-mock.com/mock/59dddf4f88ea025ff441901d/AnyCar/city';
    return this.http.get(api, this.requestOptions)
      .toPromise()
      .then( response => {
        this.cities = response.json().data.cities;
        console.log(this.cities);
        this.events.publish('city:loaded',this.cities);
